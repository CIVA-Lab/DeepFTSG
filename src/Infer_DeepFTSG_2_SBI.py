...
from data.dataLoader_test import DeepFTSG_2_SBI_TestDataLoader
...
for videoPath in nameList:
    ...
    testDataset = DeepFTSG_2_SBI_TestDataLoader(folderData, folderBgSub, folderFlux, img_size=(imgHeight, imgWidth))
