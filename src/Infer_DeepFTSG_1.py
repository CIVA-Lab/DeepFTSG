...
for videoPath in nameList:
    ...
    folderData = sorted(glob.glob("./datasets/test/CD2014/DATASET/" + videoPath + "input/*.jpg"))
    folderBgSub = sorted(glob.glob("./datasets/test/CD2014/BGS/" + videoPath + "/*.png"))
    folderFlux = sorted(glob.glob("./datasets/test/CD2014/FLUX/" + videoPath + "/*.png"))
    ...
    # set mask path
    maskDir = os.path.join('./output/CD2014/' + modelName + '/', videoPath)
